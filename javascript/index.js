...
//Закрытие попап добавления новой карточки
function popupAddClose() {
  popupAdd.classList.toggle('popup_opened');
};
buttonAddClose.addEventListener('click', popupAddClose);

//Добавление новой карточки для кнопки сохранить
...
//попап на добавление фотографии
